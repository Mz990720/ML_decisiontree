...
sourceCpp('C:\\Users\\zhangbokang\\Desktop\\2019summer\\code\\Rport_1.cpp')  # Rport_1 is a special code for skip 
...
n_best <- 5000 # number of observations to calculate best tree
#n_test <- 15000 # number of observations to test learned trees
p <- 10 # number of features
k <- 3 # number of actions
#list1 <- list(c(2,5,3),21.3,sin)
jumps <- list(2,5,10,20,40,80) # a list to store the jump stemps 
